...
public class StompUtils {
   ...
   public static void copyStandardHeadersFromMessageToFrame(Message message,
      ...
      if (message.containsProperty(Message.HDR_INGRESS_TIME)) {
         command.addHeader(Stomp.Headers.Message.INGRESS_TIME, Long.toString(message.getLongProperty(Message.HDR_INGRESS_TIME)));
      }
