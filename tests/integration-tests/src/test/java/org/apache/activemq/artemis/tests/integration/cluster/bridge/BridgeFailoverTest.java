...
public class BridgeFailoverTest extends MultiServerTestBase {
   ...
   public void testSimpleConnectOnMultipleNodes() throws Exception {
      ...
      for (ActiveMQServer server : servers) {
         server.getConfiguration().getQueueConfigs().add(new QueueConfiguration(ORIGINAL_QUEUE));
         server.getConfiguration().getQueueConfigs().add(new QueueConfiguration(TARGET_QUEUE));
      }
