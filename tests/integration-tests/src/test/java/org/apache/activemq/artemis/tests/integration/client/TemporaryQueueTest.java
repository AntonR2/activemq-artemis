...
public class TemporaryQueueTest extends SingleServerTestBase {
   ...
   public void testConsumeFromTemporaryQueue() throws Exception {
      ...
      session.createTemporaryQueue(new QueueConfiguration(queue).setAddress(address));
   ...
   public void testQueueWithWildcard() throws Exception {
      ...
      session.createTemporaryQueue(new QueueConfiguration("queue2").setAddress("a.#"));
      session.createTemporaryQueue(new QueueConfiguration("queue3").setAddress("a.#"));
   ...
   public void testQueueWithWildcard3() throws Exception {
      session.createQueue(new QueueConfiguration("queue1").setAddress("a.b"));
      session.createTemporaryQueue(new QueueConfiguration("queue2").setAddress("a.#"));
      session.createTemporaryQueue(new QueueConfiguration("queue2.1").setAddress("a.#"));
   ...
   public void testRecreateConsumerOverServerFailure() throws Exception {
      ...
      session.createTemporaryQueue(new QueueConfiguration("tmpQ").setAddress("tmpAd"));
   ...
   public void testTemporaryQueuesWithFilter() throws Exception {
      ...
      for (int i = 0; i < iterations; i++) {
         ...
         sessConsumerRed.createTemporaryQueue(new QueueConfiguration(queueRed).setAddress(address).setFilterString("color='red'"));
         ...
         sessConsumerBlue.createTemporaryQueue(new QueueConfiguration(queueBlue).setAddress(address).setFilterString("color='blue'"));
   ...
   public void testBlockingWithTemporaryQueue() throws Exception {
      ...
      consumerSession.createTemporaryQueue(new QueueConfiguration("Q1").setAddress("TestAD"));
      ...
      newConsumerSession.createTemporaryQueue(new QueueConfiguration("Q2").setAddress("TestAD"));
